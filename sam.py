...
TOKEN = '7966985849:AAEcUXuUIO0Sk64z-2vbVrFFrxuz7fL9p3Y'
...
def handle_button_response(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "Click here to join our official channel: [Join Channel](https://t.me/+5Ig7AVsqWowwM2I1)", parse_mode="Markdown")
        ...
        bot.send_message(message.chat.id, "You can reach our support team here: [Support Contact](@ILLEGALCHEAT78)", parse_mode="Markdown")
    else:
